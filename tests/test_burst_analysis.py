# tests for burst extraction (burst_analysis.py): packet direction and
# grouping consecutive same-direction packets into bursts. no pcap or
# tcpdump needed, just plain in-memory data
...
def test_packet_between_two_non_local_addresses_has_no_direction():
    ...
    # interface, but the function shouldn't guess either
    local_ips = {"192.168.1.10"}
