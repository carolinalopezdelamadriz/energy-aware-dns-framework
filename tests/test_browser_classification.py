# tests for resource origin classification (browser.py): first-party vs
# third-party vs tracker/ads - backs the resource-origin breakdown in the
# thesis (Chapter 6), worth pinning down
...
def test_known_tracker_domain_is_classified_as_tracker_before_third_party():
    # doubleclick.net is in TRACKER_DOMAINS and also, by definition, a
    # different domain from the visited site - has to be labeled tracker,
    # not fall through to third_party
...
def test_lookalike_word_is_not_misclassified_as_tracker():
    ...
    # the keyword check needs to be specific enough not to match this
