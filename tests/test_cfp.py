# tests for the bytes -> energy -> CO2 model (cfp.py) - pins down the
# equations from the thesis (Chapter 3) so a change to the formula, not
# just the constants, fails loudly here
import pytest
