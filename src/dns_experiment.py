...
def run_dns_experiment(
    ...
    # burst features (packet sizes/timing by direction) for the
    # fingerprinting angle - even when the query itself is encrypted
    # (DoH/DoQ), the shape of the bursts is still visible on the wire
